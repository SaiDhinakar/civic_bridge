export const sidebarData = {
    success: true,
    data: [
      { id: "dashboard", label: "Dashboard", path: "/volunteer/dashboard", icon: "ri-dashboard-line" },
      { id: "opportunities", label: "Opportunities", path: "/volunteer/opportunities", icon: "ri-briefcase-4-line" },
